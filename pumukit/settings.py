...
# Domain of Pumukit instance. For example: pumukitinstance.com
DOMAIN = 'localhost'

# Open edX URI for Pumukit instance with SSO: For example: openedx/sso
SSO_URI = 'openedx/sso'

# Pumukit Media Manager URI. For example: manager
MANAGER_URI = 'manager'

# Pumukit Iframe URI. For example: iframe
IFRAME_URI = 'openedx/openedx/embed'

# Pumukit API Video URI. For example: video.json
VIDEO_URI = 'video.json'

# Pumukit Personal Recorder URI. For example: personal_recorder
PERSONAL_RECORDER_URI = 'personal_recorder'

# Pumukit Wizard Simple Upload URI. For example: upload
UPLOAD_URI = 'upload'

# Pumukit Open edX Bundle defined password.
PASSWORD = 'AddPumukitOpenEdxBundlePasswordHere'
